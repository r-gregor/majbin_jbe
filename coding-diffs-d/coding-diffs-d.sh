...
remote_base="${HOME}/OLDHDD/Dropbox/ODPRTO/MCDN_en/coding"
...
echo "---"
diff -q ${CODING_LOCAL} ${CODING_REMOTE} | sed -e 's/\/home\/.*majstaf.*\//LOCAL  :: /g' -e 's/\/home\/.*OLDHDD.*\//REMOTE :: /g' -e 's/Files LOCAL/        Files/g' # | grep -vi common
